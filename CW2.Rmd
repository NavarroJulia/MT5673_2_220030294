...
k= 99 # need to add 99 more because the first 99 do not show otherwise in the loop

NRepeat <- 500 + k # no. of bootstrapped samples
...
VecProb <- bootRes[c(100:nrow(bootRes)),]
