...
## if frequency of 0 ==3 or 1==7 game ends


## what is expected number of games?

                    ##while (sum(length(WINorLOSS[WINorLOSS == 1])) = 7 | sum(length(WINorLOSS[WINorLOSS == 0])) = 3{
                          ##while (count(WINorLOSS[WINorLOSS == w]) = 7 | count(WINorLOSS[WINorLOSS == l] = 3)){
